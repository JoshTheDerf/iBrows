...
var main = function () {
  api.registerURLMapping('ibrows:blank', 'file://' + path.resolve('./src/pages/blank.html'))
  api.registerURLMapping('ibrows:error:generic', 'file://' + path.resolve('./src/pages/error/generic.html'))
  api.loadExtensions()
